...
Set up Remote - WSL and follow the instructions to install (only needed for WSL, and if using VSCode):
...
#### Install eza, tokei, fzf, fastfetch and zoxide

Check if you have any installed first to avoid duplicates.
...
Then install commonly used build tools:
...
Initialize nvim folder as a git repository and add your neovim config:
...
Run checkhealth for your plugin manager and then all of your plugins individually to see if everything works or you are missing common tools (ex: unzip, ripgrep):
...
Don't forget to check all your options and keybindings!
